...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::tooltip.index','data' => ['content' => ''.e(__('Strikethrough')).'','kbd' => '⌘+Shift+S','class' => 'contents']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['content' => ''.e(__('Strikethrough')).'','kbd' => '⌘+Shift+S','class' => 'contents']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::editor.button','data' => ['dataEditor' => 'strike']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-editor' => 'strike']); ?>
...
<?php endif; ?>
<?php /**PATH /Users/andrepiresdemello/Herd/SweetBreadCrumbs/vendor/livewire/flux-pro/src/../stubs/resources/views/flux/editor/strike.blade.php ENDPATH**/ ?>