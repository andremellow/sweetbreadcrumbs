            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead sort_by="priority_id" sorted_by={sorted_by} sorted_direction={sorted_direction}>
                            Priority
                        </TableHead>
                        <TableHead sort_by="created_at" sorted_by={sorted_by} sorted_direction={sorted_direction}>
                            Created At
                        </TableHead>
