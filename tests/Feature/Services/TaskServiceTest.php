...
beforeEach(function () {
    ...
    $this->service = new TaskService(closeTask: $this->mockCloseTask, openTask: $this->mockOpenTask);
});
...
// it('creates a task using CreateMeeting action', function () {
//     /** @var Project $project */
...
describe('list tasks', function () {
    beforeEach(function () {
        Task::factory()->for($this->project)->create(['name' => 'Stand up 1',           'description' => 'Description for Stand up 1',          'priority_id' => 6,  /* Highest */  'due_date' => Carbon::now()->addDays(9), 'completed_at' => Carbon::now()->addDays(9)]);
        Task::factory()->for($this->project)->create(['name' => 'Stand up 2',           'description' => 'Description for Stand up 2',          'priority_id' => 6,  /* Highest */  'due_date' => Carbon::now()->addDays(8)]);
        Task::factory()->for($this->project)->create(['name' => 'Stand up 3',           'description' => 'Description for Stand up 3',          'priority_id' => 7,  /* High */     'due_date' => Carbon::now()->addDays(7)]);
        Task::factory()->for($this->project)->create(['name' => 'TD descusion 1',       'description' => 'Description for TD descusion 1',      'priority_id' => 7,  /* High */     'due_date' => Carbon::now()->addDays(6)]);
        Task::factory()->for($this->project)->create(['name' => 'TD descusion 2',       'description' => 'Description for TD descusion 2',      'priority_id' => 8,  /* Midium */   'due_date' => Carbon::now()->addDays(5)]);
        Task::factory()->for($this->project)->create(['name' => 'TD descusion 3',       'description' => 'Description for TD descusion 3',      'priority_id' => 6,  /* Highest */   'due_date' => Carbon::now()->addDays(4)]);
        Task::factory()->for($this->project)->create(['name' => 'Sprint planing 1',     'description' => 'Description for Sprint planing 1',    'priority_id' => 9,  /* Low */      'due_date' => Carbon::now()->addDays(3)]);
        Task::factory()->for($this->project)->create(['name' => 'Sprint planing 2',     'description' => 'Description for Sprint planing 2',    'priority_id' => 10, /* Lowest */   'due_date' => Carbon::now()->addDays(-1)]);
        Task::factory()->for($this->project)->create(['name' => 'Sprint planing 3',     'description' => 'Description for Sprint planing 3',    'priority_id' => 10, /* Lowest */   'due_date' => Carbon::now()->addDays(-2), 'completed_at' => Carbon::now()->addDays(1)]);
    });
